...
void sauvegarde(Case** matriceCases, Global* structureGlobale){
    ...
    if(fichier != NULL) {
        ...
        fprintf(fichier, "%d %d %d %d", structureGlobale->argentBanque, structureGlobale->nbHabitants, structureGlobale->timerPartieSec, structureGlobale->modeDeJeu);
...
void chargement(Case** matriceCases, Global* structureGlobale){
    ...
    fscanf(fichier,"%d %d %d %d",&structureGlobale->argentBanque, &structureGlobale->nbHabitants, &structureGlobale->timerPartieSec, &structureGlobale->modeDeJeu);
}